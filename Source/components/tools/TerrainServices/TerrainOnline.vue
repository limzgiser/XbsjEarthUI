<template>
<Window :footervisible="true" @ok="ok" @cancel="show=false" v-show="show" :height="420" :width="500" :minWidth="202" :left="200" :top="150" :title="lang.title" class="xbsj-onlineTerrain">
    ...
    <div class="onlineTerrainDiv">
        ...
        <input class="inputcheck" type="radio" id="cesiumtype" v-model="terrainType" value="XbsjCesiumTerrainProvider" name="terrainType" style="vertical-align: top;" />
        <label style="cursor:pointer;width:26px;" for="cesiumtype">{{lang.cesiumterrain}}</label>
        <input class="inputcheck" type="radio" id="googletype" v-model="terrainType" value="GoogleEarthEnterpriseTerrainProvider" name="terrainType" style="vertical-align: top;" />
...
export default {
    ...
    methods: {
        getonlineinfo() {
            ...
            let url = labServer.server + "online/terrains/";
            axios
                .get(url, {
                    params: {
                        // desc: false
