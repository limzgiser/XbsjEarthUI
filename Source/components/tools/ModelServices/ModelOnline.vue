<template>
<Window :footervisible="true" @ok="ok" @cancel="show=false" v-show="show" :height="420" :width="500" :minWidth="202" :left="200" :top="150" :title="lang.title" class="xbsj-onlineModel">
...
export default {
    ...
    methods: {
        getonlineinfo() {
            ...
            let url = labServer.server + "online/tilesets/";
            axios
                .get(url, {
                    params: {
                        // desc: false
