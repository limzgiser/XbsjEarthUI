<template>
<Window :footervisible="true" @cancel="show=false" @ok="ok" v-show="show" :width="463" :minWidth="202" :height="500" :left="5" :top="150" :title="lang.localtitle" class="xbsj-localImage">
    ...
    <div class="contentDiv" :class="contentShow ? 'contentsDiv' : ''">
        <div v-for="days in dayItems" :key="days.day" class="dateDiv">
            ...
            <ul class="flexul">
                <li v-for="(s,index) in days.services" @click="select(s)" @contextmenu.prevent="onContexMenu(s, $event)" :key="index">
