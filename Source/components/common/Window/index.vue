...
<div ref="xbsjmodelbox" class="xbsj-model-box" :class="{'xbsj-model-box-close':collapsed}" :style="windowstyle" @click="showclick">
    ...
    <div class="xbsj-model-header" ref="xbsjmodelheader" @mousedown="startMove($event)">
        {{title}}
        <span class="xbsj-model-arrow" :class="{'closestatus':collapsed}" @click.stop="collapse"></span>
        <span class="xbsj-model-close" @click.stop="cancel"></span>
    </div>
    <!-- 内容 -->
    <div class="xbsj-model-content" :class="{'xbsj-model-closetatus-body':collapsed,'xbsj-model-nofooter':footervisible}" ref="xbsjmodelbody" @contextmenu.prevent="contextMenu">
