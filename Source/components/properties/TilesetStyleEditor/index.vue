<template>
<Window :title="title" :width="700" :height="445" :minWidth="380" @ok="ok" @cancel="cancel" :footervisible="true">
    <div class="container">
        <div class="left">
...
" target="__black" style="padding: 1.5px 15px; margin-right: 15px;">{{lang.styledescription}}</a>
        ...
        <div class="right" @contextmenu.prevent="popMenuAdd" @click="cancelEditting($event)">
            <ul ref="right">
                <li v-for="(s,index) in styles" :class="{highlight:selected == s}" @contextmenu.prevent="popMenuStyle(s,index)" @click="selectStyle(s)" :key="index">
                    <img :src="s.thumbnail" />
                    <div v-if="!s.editting">
                        {{s.name}}
