...
<div class="xbsj-template">
    <div class="xbsj-list" ref="container" @mousedown="startMove($event)" @mousemove="onMoving($event)" @mouseup="endMove($event)">
        ...
        <div class="xbsj-list-item">
            ...
            <div class="xbsj-item-btnbox ml20" @click="popup=!popup" v-show="splitX<=0&&splitY<=0||splitX<=0&&splitY>=1||splitX>=1&&splitY<=0||splitX>=1&&splitY>=1">
            ...
            <div class="xbsj-item-btnbox ml20" @click="popup=!popup" v-show="(splitX > 0 && splitX < 1 && !(splitY > 0 && splitY < 1))">
                <div class="xbsj-item-btn leftrightbutton" :class="(splitX > 0 && splitX < 1 && !(splitY > 0 && splitY < 1)) ? 'leftrightbuttonActive' : ''"></div>
            ...
            <div class="xbsj-item-btnbox" @click="popup=!popup" v-show="(!(splitX > 0 && splitX < 1) && splitY > 0 && splitY < 1)">
                <div class="xbsj-item-btn upanddownbutton" :class="(!(splitX > 0 && splitX < 1) && splitY > 0 && splitY < 1) ? 'upanddownbuttonActive' : ''"></div>
                <span class="xbsj-item-name">{{lang.upanddown}}</span>
            </div>
            <div class="xbsj-item-btnbox" @click="popup=!popup" v-show="(splitX > 0 && splitX < 1 && splitY > 0 && splitY < 1)">
                <div class="xbsj-item-btn fourpointsbutton" :class="(splitX > 0 && splitX < 1 && splitY > 0 && splitY < 1) ? 'fourpointsbuttonActive' : ''"></div>
