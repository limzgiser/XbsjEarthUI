    ...
    >
     ...
     v-if="menuConfig.view.control.layer"
        ...
        <div
          ...
          v-if="menuConfig.view.control.navcontrol"
        >
          <div
       ...
       v-if="menuConfig.view.control.scalecontrol"
        >
          <div
        ...
        v-if="menuConfig.view.control.statecontrol"
        >
          <div
        ...
        <div
          ...
          @click="timelinecontrolShow = !timelinecontrolShow"
              v-if="menuConfig.view.control.timelinecontrol"
        >
          <div
        ...
        <div
          class="xbsj-item-btnbox"
          @click="modelTreeShow = !modelTreeShow"
                  v-if="menuConfig.view.control.modelTree"
        >
          <div
            class="xbsj-item-btn scenebutton"
            :class="{ highlight: modelTreeShow }"
          ></div>
          <span class="xbsj-item-name">{{ lang.modelTree }}</span>
        </div>
        <div
          class="xbsj-item-btnbox"
          @click="tilesTestShow = !tilesTestShow"
                        v-if="menuConfig.view.control.autoTest"
        >
          <div
      ...
      <div class="xbsj-list-item"  v-if="menuConfig.view && menuConfig.view.splitscreen">
        <span
          class="xbsj-list-name"
     
          >{{ lang.splitscreen }}</span
        >
        <div
          class="xbsj-item-btnbox ml20"
         v-if=" menuConfig.view.splitscreen.singleviewport"
          @click="popup = !popup"
          v-show="
            (splitX <= 0 && splitY <= 0) ||
              (splitX <= 0 && splitY >= 1) ||
        ...
        >
          <div
            class="xbsj-item-btn singleviewportbutton singleviewportbuttonActive"
          ></div>
      ...
      <div class="xbsj-list-item xbsj-list-lastitem"      v-if="menuConfig.view && menuConfig.view.debug">
        <span
          class="xbsj-list-name"
        ...
        <div
          class="xbsj-item-btnbox ml20"
        v-if="menuConfig.view.debug.terraindebug"
        ...
        <div
          class="xbsj-item-btnbox"
          v-if="menuConfig.view.debug.dtilesdebug"
          @click="cesiumDebug = !cesiumDebug"
        >
          <div
        ...
        <div
          class="xbsj-item-btnbox"
         v-if="menuConfig.view.debug.capture"
          @click="capture"
        >
        ...
        <div
          class="xbsj-item-btnbox"
           v-if="menuConfig.view.debug.earthColor"
        >
...
import menucfg from "../menu.config";
export default {
  data() {
    return {
      layerShow: true,
