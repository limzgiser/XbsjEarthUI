...
<div class="xbsj-template">
    ...
    -->
            ...
            <span class="xbsj-select" :class="{highlight:popup == 'sceneView'}" @click.stop="togglePopup('sceneView',$event)"></span>
            <!--场景另存 -->
        ...
        <!-- <div class="xbsj-list-item">
            ...
            <span class="xbsj-select" :class="{highlight:popup == 'globeView'}" @click.stop="togglePopup('globeView',$event)"></span>

            <div class="xbsj-item-btnbox">
                <div class="xbsj-item-btn chinabutton" @click="flyToChina"></div>
                <span class="xbsj-item-name">{{lang.china}}</span>
            </div>
            <span class="xbsj-select" :class="{highlight:popup == 'chinaView'}" @click.stop="togglePopup('chinaView',$event)"></span>
        ...
        <div class="xbsj-list-item">
            ...
            <div class="xbsj-item-btnbox">
                <div class="xbsj-item-btn globalrotationbutton" :class="{highlight: cameraMode=='rotateGlobe'}" @click="toggleCameraFlight('rotateGlobe')"></div>
                <span class="xbsj-item-name">{{lang.globalrotation}}</span>
            </div>
            <span class="xbsj-select" :class="{highlight:popup == 'rotateGlobe'}" @click.stop="togglePopup('rotateGlobe',$event)"></span>
            <div class="xbsj-item-btnbox">
                <div class="xbsj-item-btn centerrotationbutton" :class="{highlight: cameraMode=='rotateCenter'}" @click="toggleCameraFlight('rotateCenter')"></div>
                <span class="xbsj-item-name">{{lang.centerrotation}}</span>
            </div>
            <span class="xbsj-select" :class="{highlight:popup == 'rotateCenter'}" @click.stop="togglePopup('rotateCenter',$event)"></span>
            <!-- 绑定相机 -->
            <div class="xbsj-item-btnbox" ref="cameraAttach" @click="cameraattachbtn">
                <div class="xbsj-item-btn cameraattachbutton" :class=" {  cameraattachbuttonActive : cameraAttached || cameraAttachOver }"></div>
        ...
        <div class="xbsj-list-item xbsj-list-lastitem">
            ...
            <span class="xbsj-select" :class="{highlight:popup == 'firstPerson'}" @click.stop="togglePopup('firstPerson',$event)"></span>
            ...
            <span class="xbsj-select" :class="{highlight:popup == 'pickObject'}" @click.stop="togglePopup('pickObject',$event)"></span>
            <!-- vr -->
...
import SceneSaveAsComp from "./SceneSaveAs";
